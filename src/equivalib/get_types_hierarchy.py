...
import dataclasses
from typing import Iterable, Iterator, Union, Literal, Dict, Optional, Sequence, List
...
def get_types_hierarchy(types: Iterable[TypeForm]) -> Iterator[Sequence[TypeForm]]:
    before: Dict[TypeForm, List[TypeForm]] = {}
    all_types: List[TypeForm] = []
