...
from typing import Callable, TypeVar, Set, Generator, Iterable

T = TypeVar('T')

def partially_order(elements: Iterable[T], before: Callable[[T], Iterable[T]]) -> Generator[Set[T], None, None]:
    """
    ...
    while remaining:
        ...
        for elem in remaining:
            ...
            smaller_elements = set(before(elem))
