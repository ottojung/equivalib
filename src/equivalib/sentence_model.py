...
import typing
from typing import Optional, Dict, Type, Tuple, List, Union, Sequence
...
class SentenceModel:
    ...
    _names: Dict[str, Tuple[Type, Union[int, List[object]]]]
    ...
    def add_variable(self, name: str, t: Type, arg: Sequence[object]):
